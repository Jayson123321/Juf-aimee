...
export const GEN_MODEL = process.env.GEN_MODEL || "qwen2.5:72b"
...
export const RAS_GEN_MODEL = "gemma4:31b-cloud"
export const DRAWING_MODEL =  process.env.DRAWING_MODEL || "llava:13b"
