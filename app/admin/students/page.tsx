...
function StudentCard({ student }: { student: StudentWithProfile }) {
  ...
  return (
    <Card className="relative h-full transition-all duration-200 ease-out hover:ring-2 hover:ring-primary hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-0.5">
      <Link href={`/student/${student.id}`} className="absolute inset-0 z-0 rounded-xl outline-none focus-visible:ring-2 focus-visible:ring-primary" aria-label={student.fullName} />
