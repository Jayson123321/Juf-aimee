...
## Stap 2 — Injectie opgeslagen in de RAG-database (fix UIT)
...
## Stap 3 — Gegenereerde opdracht met actieve injectie
...
## Stap 4 — Fix aangezet: sanitisatie in ingest-pipeline
...
## Stap 5 — Gegenereerde opdracht na fix zelfde vergiftigd opp-profiel
...
| | Fix UIT | Fix AAN |
|---|---|---|
| Injectie in DB | ⚠️ Aanwezig (chunk 27) | ✅ Gefilterd |
