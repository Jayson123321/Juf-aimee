...
![alt text](images/beheerders-login.png)
![alt text](images/inlogscherm.png)
...
![alt text](images/opdrachten-van-leerlingen.png)
...
![alt text](images/RAS-Framework.png)
...
![alt text](images/leraren-beheerder.png)

leerlingen toevoegen aan Juf Aimee

![alt text](images/leerlingen-beheerder.png)

### Leerlingenportaal

Reflectieformulier leerling en feedback leraar voor de opdracht

![alt text](images/portfolio-inzage.png)

Uploaden resultaat van opdracht

![alt text](images/uploaden-resultaat.png)
